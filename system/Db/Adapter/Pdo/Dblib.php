 ...
 */
class Dblib extends \Phalcon\Db\Adapter\Pdo\AbstractPdo implements \Phalcon\Db\Adapter\AdapterInterface
{
    ...
    public function connect(?array $descriptor = null): bool
    {
        ...
        $dsn = "dblib:host={$descriptor['host']};dbname={$descriptor['dbname']}";
