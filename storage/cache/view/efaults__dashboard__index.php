							...
							<div class="card-body p-4">
								<div class="row g-4">
									<div class="d-flex flex-wrap align-items-center gap-3 mb-2">
										...
										<span class="badge rounded-pill bg-primary-subtle text-primary">
											Periode:
											<span class="fw-semibold ms-1"><?= numToBulan($this->session->m_periode) ?>
												<?= $this->session->y_periode ?></span>
										</span>
									</div>
									...
									<div class="col-12 col-lg-6">
										<div class="d-flex align-items-center gap-2 mb-2">
											...
											<h6 class="mb-0">Bulan Ini (<?= numToBulan($this->session->m_periode) ?>
												<?= $this->session->y_periode ?>)</h6>
										</div>
										<div class="ms-4">
									...
									<div class="col-12 col-lg-6">
										<div class="d-flex align-items-center gap-2 mb-2">
											...
											<h6 class="mb-0 text-nowrap" style="font-size: 0.75rem !important;">S.D Bulan Ini (<?= numToBulan($this->session->m_periode) ?>
												<?= $this->session->y_periode ?>)</h6>
										</div>
										<div class="ms-4">
											<div class="text-secondary small">Pendapatan</div>
							...
							<div class="card-body pt-2">
								<div class="row g-3">
									<div class="d-flex flex-wrap align-items-center gap-3 mb-2">
										...
										<span class="badge rounded-pill bg-primary-subtle text-primary">
											Periode:
											<span class="fw-semibold ms-1"><?= numToBulan($this->session->m_periode) ?> <?= $this->session->y_periode ?></span>
										</span>
									</div>
									<div class="col-12">
