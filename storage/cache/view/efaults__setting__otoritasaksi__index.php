...
if (navbarVerticalStyle === 'darker') {
	...
	<nav class="mb-3" aria-label="breadcrumb">
		<ol class="breadcrumb mb-0">
			...
			<li class="breadcrumb-item active">Otoritas Aksi</li>
		</ol>
	</nav>
	<div class="mb-9">
		<div class="row g-2 mb-4">
			<div class="col-auto">
				<h2 class="mb-0">Otoritas Aksi</h2>
			</div>
		</div>
				...
				<div class="row g-3 justify-content-end gap-2">
					<div class="col-auto">
						...
						<button class="btn btn-sm btn-primary my-1" id="btn-hak-akses">
							<span class="fas fa-chevron-right me-2"></span>
							Hak Aksi Menu
						</button>
			...
			<div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-body-emphasis border-top border-bottom border-translucent position-relative top-1">
				<div class="table-responsive scrollbar-overlay mx-n1 px-1">
					<table class="table table-sm fs-9 mb-0 table-striped table-bordered" id="datatables-otoritas-menu">
						...
						<tbody
							class="list" id="otoritas-menu-table-body"><!-- Data akan diisi dari script -->
						</tbody>
					</table>
				</div>
			</div>
