...
return str.replace(/"/g, '&quot;').replace(/'/g, '&#39;');
	...
	window.defaultUrl = `${baseUrl}panel/setting/otoritas_aksi/`;
var table;
...
function doInsert(roleid, menuid, type) {
    $.confirm({
        title: "Konfirmasi",
        theme: "modern",
        content: "Beri Aksi untuk Hak Akses ini ?",
        buttons: {
            Tidak: {
                text: "Tidak",
                btnClass: "btn-warning",
...
function doDelete(roleid, menuid, type) {
    $.confirm({
        title: "Konfirmasi",
        theme: "modern",
        content: "Hapus Aksi untuk Hak Akses ini ?",
        buttons: {
            Tidak: {
                text: "Tidak",
                btnClass: "btn-warning",
        ...
        success: function (dt) {
            ...
            $.each(dataMenu, function (index, value) {
                ...
                */
                ...
                listData += "<td class='text-center'>";
                if (value.is_input == 0) {
                    listData += "<button class='btn btn-sm btn-success' onclick=\"doInsert(" + value.id + ", " + value.menu_id + ", 'input')\"><i data-feather='check' class='feather-icon'></i></button>";
                } else {
                    listData += "<button class='btn btn-sm btn-danger' onclick=\"doDelete(" + value.id + ", " + value.menu_id + ", 'input')\"><i data-feather='x' class='feather-icon'></i></button>";
                }
                listData += "</td>";
                ...
                listData += "<td class='text-center'>";
                if (value.is_ubah == 0) {
                    listData += "<button class='btn btn-sm btn-success' onclick=\"doInsert(" + value.id + ", " + value.menu_id + ", 'ubah')\"><i data-feather='check' class='feather-icon'></i></button>";
                } else {
                    listData += "<button class='btn btn-sm btn-danger' onclick=\"doDelete(" + value.id + ", " + value.menu_id + ", 'ubah')\"><i data-feather='x' class='feather-icon'></i></button>";
                }
                listData += "</td>";
                ...
                listData += "<td class='text-center'>";
                if (value.is_hapus == 0) {
                    listData += "<button class='btn btn-sm btn-success' onclick=\"doInsert(" + value.id + ", " + value.menu_id + ", 'hapus')\"><i data-feather='check' class='feather-icon'></i></button>";
                } else {
                    listData += "<button class='btn btn-sm btn-danger' onclick=\"doDelete(" + value.id + ", " + value.menu_id + ", 'hapus')\"><i data-feather='x' class='feather-icon'></i></button>";
                }
                listData += "</td>";
                ...
                listData += "<td class='text-center'>";
                if (value.is_cetak == 0) {
                    listData += "<button class='btn btn-sm btn-success' onclick=\"doInsert(" + value.id + ", " + value.menu_id + ", 'cetak')\"><i data-feather='check' class='feather-icon'></i></button>";
                } else {
                    listData += "<button class='btn btn-sm btn-danger' onclick=\"doDelete(" + value.id + ", " + value.menu_id + ", 'cetak')\"><i data-feather='x' class='feather-icon'></i></button>";
                }
                listData += "</td>";
                ...
                if (value.is_verifikasi == 0) {
                    listData += "<button class='btn btn-sm btn-success' onclick=\"doInsert(" + value.id + ", " + value.menu_id + ", 'verifikasi')\"><i data-feather='check' class='feather-icon'></i></button>";
                } else {
                    listData += "<button class='btn btn-sm btn-danger' onclick=\"doDelete(" + value.id + ", " + value.menu_id + ", 'verifikasi')\"><i data-feather='x' class='feather-icon'></i></button>";
                }
                listData += "</td>";
                ...
                // Aksi Verifikasi
                listData += "<td class='text-center'>";
                if (value.is_unverifikasi == 0) {
                    listData += "<button class='btn btn-sm btn-success' onclick=\"doInsert(" + value.id + ", " + value.menu_id + ", 'unverifikasi')\"><i data-feather='check' class='feather-icon'></i></button>";
                } else {
                    listData += "<button class='btn btn-sm btn-danger' onclick=\"doDelete(" + value.id + ", " + value.menu_id + ", 'unverifikasi')\"><i data-feather='x' class='feather-icon'></i></button>";
                }
                listData += "</td>";
