...
trait VoucherJurnalTemplate
{
    public function renderVoucher(array $Mjournal, array $Djournal, $title1 = '', $title2 = '', $namaJudul = 'JURNAL')
    {
        ...
        $this->SetTitle('V : ' . $Mjournal['mjo_code']);
        ...
        $this->Cell(0, 0.5, $title1, 0, 0, 'C');
        $this->Ln();
        $this->Cell(0, 0.5, $title2, 0, 0, 'C');
        $this->Ln(1);

        // Header tabel menggunakan easy table
