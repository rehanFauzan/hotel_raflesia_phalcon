...
class Controller extends BaseController
{
    ...
    public function datatableAction()
    {
        $builder = $this->modelsManager->createBuilder()
            ...
            ->from(Model::class)
            ->where("1=1")
            ->orderBy("CAST(kode AS SIGNED) ASC");
    ...
    public function updateDataAction()
    {
        ...
        $npwp = escape_xss($this->request->getPost('npwp'));
        $penanggung_jawab = escape_xss($this->request->getPost('penanggung_jawab'));
        $is_rekanan = escape_xss($this->request->getPost('is_rekanan'));
        ...
        try {
            ...
            $lastInsertedId = $actTransactData->kode;
            $this->db->commit();
