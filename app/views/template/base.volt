...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
	...
	<head>
		...
		<!--    Favicons-->
		<!-- ===============================================-->
		<!-- Font Awesome --> <link rel="stylesheet"href="{{ url('lib_independent') }}/font-awesome.min.css"/> <link rel="apple-touch-icon" sizes="180x180" href="{{ url('external_img') }}/favicons/apple-touch-icon.png">
		...
		<link
		rel="manifest" href="{{ url('external_img') }}/favicons/manifest.json">
		<!-- Styles -->
		...
		<link rel="stylesheet" href="{{ url('lib_independent') }}/jquery-confirm.min.css"/>
		<link rel="stylesheet" href="{{ url('lib_independent') }}/notyf.min.css">
		...
		<link href="{{ url('lib_independent') }}/css2.css" rel="stylesheet">
		...
		<link href="{{ url('lib_independent') }}/flatpickr.css" rel="stylesheet">
		<link href="{{ url('lib_independent') }}/style.css" rel="stylesheet">
		<link href="{{ url('lib_independent') }}/light.css" rel="stylesheet">
		<link href="{{ url('vendors') }}/summernote-0.9.0/summernote-bs5.min.css" rel="stylesheet">
		<link rel="stylesheet" type="text/css" href="{{ url('vendors') }}/bootstrap-datepicker-1.9.0/css/bootstrap-datepicker3.standalone.css">

		<script>
			{% include "template/base_header.js" %}</script>
...
<body>
		...
		<nav class="navbar navbar-vertical navbar-expand-lg" style="display:none;">
			<div
				...
				<div class="navbar-vertical-content">
					...
					{# Isi Ini Dengan Template #}
					{# {% include "template/temp_navbar_vertical.volt" %} #}

						{% block navigation %}
					{% include 'template/navigation-dynamic-vertical.volt' %}
				{% endblock %}
	...
	<nav class="navbar navbar-top fixed-top navbar-expand" id="navbarDefault" style="display:none;">
		<div class="collapse navbar-collapse justify-content-between">
			...
			{# Ini Bekas Widget Box Pencarian #}
		...
		<div class="collapse navbar-collapse justify-content-between">
			...
			<ul class="navbar-nav navbar-nav-icons flex-row">
				...
				<li class="nav-item dropdown">
					...
					{% include "template/base_profile_user.volt" %}
				</li>
			</ul>
		</div>
	</nav>
	...
	<nav class="navbar navbar-top fixed-top navbar-expand-lg" id="navbarTop" style="display:none;">
		...
		<div class="collapse navbar-collapse navbar-top-collapse order-1 order-lg-0 justify-content-center" id="navbarTopCollapse">
			{% include 'template/navigation-dynamic-horizontal-navbartop.volt' %}
		</div>
		<ul class="navbar-nav navbar-nav-icons flex-row">
			<li class="nav-item">
	...
	<nav class="navbar navbar-top navbar-slim justify-content-between fixed-top navbar-expand-lg" id="navbarTopSlim" style="display:none;">
		...
		<div class="collapse navbar-collapse navbar-top-collapse order-1 order-lg-0 justify-content-center" id="navbarTopCollapse">
			{% include 'template/navigation-dynamic-horizontal.volt' %}
		</div>
		<ul class="navbar-nav navbar-nav-icons flex-row">
			<li class="nav-item">
				<div class="theme-control-toggle fa-ion-wait pe-2 theme-control-toggle-slim"><input class="form-check-input ms-0 theme-control-toggle-input" id="themeControlToggle" type="checkbox" data-theme-control="phoenixTheme" value="dark"/><label class="mb-0 theme-control-toggle-label theme-control-toggle-light" for="themeControlToggle" data-bs-toggle="tooltip" data-bs-placement="left" title="Switch theme">
	...
	<script>
		{% include "template/base_footer.js" %}</script>
	<div
		class="content">
		<!--
															<div class="d-flex flex-center content-min-h">
																<div class="text-center py-9"><img class="img-fluid mb-7 d-dark-none" src="{{ url('assets') }}/img/spot-illustrations/2.png" width="470" alt=""/>
																	<img class="img-fluid mb-7 d-light-none" src="{{ url('assets') }}/img/spot-illustrations/dark_2.png" width="470" alt=""/>
...
<div class="setting-panel-item mt-0">
	...
	<div class="row gx-2">
		<div class="col-4"><input class="btn-check" id="themeSwitcherLight" name="theme-color" type="radio" value="light" data-theme-control="phoenixTheme"/><label class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherLight">
				<span class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="{{ url('assets') }}/img/generic/default-light.png" alt=""/></span>
		...
		<div class="col-4"><input class="btn-check" id="themeSwitcherDark" name="theme-color" type="radio" value="dark" data-theme-control="phoenixTheme"/><label class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherDark">
				<span class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="{{ url('assets') }}/img/generic/default-dark.png" alt=""/></span>
		...
		<div class="col-4"><input class="btn-check" id="themeSwitcherAuto" name="theme-color" type="radio" value="auto" data-theme-control="phoenixTheme"/><label class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherAuto">
				<span class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="{{ url('assets') }}/img/generic/auto.png" alt=""/></span>
				<span class="label-text">
					Auto</span>
			</label>
		</div>
...
<div class="setting-panel-item">
	...
	<div class="row gx-2">
		<div class="col-6"><input class="btn-check" id="navbarPositionVertical" name="navigation-type" type="radio" value="vertical" data-theme-control="phoenixNavbarPosition"/><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionVertical">
				<span class="rounded d-block"><img class="img-fluid img-prototype d-dark-none" src="{{ url('assets') }}/img/generic/default-light.png" alt=""/><img class="img-fluid img-prototype d-light-none" src="{{ url('assets') }}/img/generic/default-dark.png" alt=""/></span>
		...
		<div class="col-6"><input class="btn-check" id="navbarPositionHorizontal" name="navigation-type" type="radio" value="horizontal" data-theme-control="phoenixNavbarPosition"/><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionHorizontal">
				<span class="rounded d-block"><img class="img-fluid img-prototype d-dark-none" src="{{ url('assets') }}/img/generic/top-default.png" alt=""/><img class="img-fluid img-prototype d-light-none" src="{{ url('assets') }}/img/generic/top-default-dark.png" alt=""/></span>
				<span class="label-text">
					Horizontal</span>
			</label>
		</div>
		<div class="col-6"><input class="btn-check" id="navbarPositionCombo" name="navigation-type" type="radio" value="combo" data-theme-control="phoenixNavbarPosition"/><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionCombo">
				<span class="rounded d-block"><img class="img-fluid img-prototype d-dark-none" src="{{ url('assets') }}/img/generic/nav-combo-light.png" alt=""/><img class="img-fluid img-prototype d-light-none" src="{{ url('assets') }}/img/generic/nav-combo-dark.png" alt=""/></span>
				<span class="label-text">
					Combo</span>
			</label>
		</div>
		<!-- 
											<div class="col-6"><input class="btn-check" id="navbarPositionTopDouble" name="navigation-type" type="radio" value="dual-nav" data-theme-control="phoenixNavbarPosition"/><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionTopDouble">
													<span class="rounded d-block"><img class="img-fluid img-prototype d-dark-none" src="{{ url('assets') }}/img/generic/dual-light.png" alt=""/><img class="img-fluid img-prototype d-light-none" src="{{ url('assets') }}/img/generic/dual-dark.png" alt=""/></span>
													<span class="label-text">
														Dual
																		nav</span>
												</label>
			...
			<div class="setting-panel-item">
				...
				<div class="row gx-2">
					<div class="col-6"><input class="btn-check" id="navbar-style-default" type="radio" name="config.name" value="default" data-theme-control="phoenixNavbarVerticalStyle"/><label class="btn d-block w-100 btn-navbar-style fs-9" for="navbar-style-default">
							<img class="img-fluid img-prototype d-dark-none" src="{{ url('assets') }}/img/generic/default-light.png" alt=""/><img class="img-fluid img-prototype d-light-none" src="{{ url('assets') }}/img/generic/default-dark.png" alt=""/><span class="label-text d-dark-none">
								Default</span>
					...
					<div class="col-6"><input class="btn-check" id="navbar-style-dark" type="radio" name="config.name" value="darker" data-theme-control="phoenixNavbarVerticalStyle"/><label class="btn d-block w-100 btn-navbar-style fs-9" for="navbar-style-dark">
							<img class="img-fluid img-prototype d-dark-none" src="{{ url('assets') }}/img/generic/vertical-darker.png" alt=""/><img class="img-fluid img-prototype d-light-none" src="{{ url('assets') }}/img/generic/vertical-lighter.png" alt=""/><span class="label-text d-dark-none">
								Darker</span>
			...
			<div class="setting-panel-item">
				...
				<div class="row gx-2">
					<div class="col-6"><input class="btn-check" id="navbarShapeDefault" name="navbar-shape" type="radio" value="default" data-theme-control="phoenixNavbarTopShape"/><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarShapeDefault">
							<span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0" src="{{ url('assets') }}/img/generic/top-default.png" alt=""/><img class="img-fluid img-prototype d-light-none mb-0" src="{{ url('assets') }}/img/generic/top-default-dark.png" alt=""/></span>
					...
					<div class="col-6"><input class="btn-check" id="navbarShapeSlim" name="navbar-shape" type="radio" value="slim" data-theme-control="phoenixNavbarTopShape"/><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarShapeSlim">
							<span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0" src="{{ url('assets') }}/img/generic/top-slim.png" alt=""/><img class="img-fluid img-prototype d-light-none mb-0" src="{{ url('assets') }}/img/generic/top-slim-dark.png" alt=""/></span>
							<span class="label-text">
								Slim</span>
						</label>
					</div>
...
<div class="setting-panel-item">
	...
	<div class="row gx-2">
		<div class="col-6"><input class="btn-check" id="navbarTopDefault" name="navbar-top-style" type="radio" value="default" data-theme-control="phoenixNavbarTopStyle"/><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarTopDefault">
				<span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0" src="{{ url('assets') }}/img/generic/top-default.png" alt=""/><img class="img-fluid img-prototype d-light-none mb-0" src="{{ url('assets') }}/img/generic/top-style-darker.png" alt=""/></span>
				<span class="label-text">Default</span>
			</label>
		</div>
		<div class="col-6"><input class="btn-check" id="navbarTopDarker" name="navbar-top-style" type="radio" value="darker" data-theme-control="phoenixNavbarTopStyle"/><label class="btn d-inline-block btn-navbar-style fs-9" for="navbarTopDarker">
				<span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0" src="{{ url('assets') }}/img/generic/navbar-top-style-light.png" alt=""/><img class="img-fluid img-prototype d-light-none mb-0" src="{{ url('assets') }}/img/generic/top-style-lighter.png" alt=""/></span>
...
<small class="text-uppercase text-body-tertiary fw-bold py-2 pe-2 ps-1 rounded-end">customize</small></div></a><!-- ===============================================--><!--    JavaScripts--><!-- ===============================================--><script src="{{ url('vendors') }}/popper/popper.min.js"> </script><script src="{{ url('vendors') }}/bootstrap/bootstrap.min.js"></script><script src="{{ url('vendors') }}/anchorjs/anchor.min.js"></script><script src="{{ url('vendors') }}/is/is.min.js"></script><script src="{{ url('vendors') }}/fontawesome/all.min.js"></script><script src="{{ url('vendors') }}/lodash/lodash.min.js"></script><script src="{{ url('vendors') }}/list.js/list.min.js"></script><script src="{{ url('vendors') }}/feather-icons/feather.min.js"></script><script src="{{ url('vendors') }}/dayjs/dayjs.min.js"></script><script src="{{ url('vendors') }}/choices/choices.min.js"></script><script src="{{ url('vendors') }}/prism/prism.js"></script><script src="{{ url('assets') }}/js/phoenix.js"></script><script src="{{ url('lib_independent') }}/jquery-3.7.1.min.js"></script><script src="{{ url('lib_independent') }}/dataTables.min.js"></script><script src="{{ url('lib_independent') }}/dataTables.bootstrap5.min.js"></script><script src="{{ url('lib_independent') }}/select2.min.js"></script><script src="{{ url('lib_independent') }}/jquery-confirm.min.js"></script><script src="{{ url('lib_independent') }}/notyf.min.js"></script><script src="{{ url('lib_independent') }}/jquery.validate.min.js"></script><script src="{{ url('lib_independent') }}/additional-methods.min.js"></script><script src="{{ url('lib_independent') }}/flatpickr.js"></script><script src="{{ url('lib_independent') }}/index.js"></script><script src="{{ url('lib_independent') }}/id.js"></script><script src="{{ url('lib_independent') }}/moment-with-locales.min.js"></script><script src="{{ url('vendors') }}/summernote-0.9.0/summernote-bs5.min.js"></script><script src="{{ url('vendors') }}/bootstrap-datepicker-1.9.0/js/bootstrap-datepicker.min.js"></script><script src="{{ url('vendors') }}/bootstrap-datepicker-1.9.0/locales/bootstrap-datepicker.id.min.js"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/autonumeric/4.10.8/autoNumeric.min.js" integrity="sha512-mD/vCchTqwSnIslMzOI7zbNeTNDqosvT7VvrNHo5xJDvg5hCpCvvct0QtHtrHouaWsI3ofL4B7nNaF8pDfg3Yw==" crossorigin="anonymous" referrerpolicy="no-referrer"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/cleave.js/1.6.0/cleave.min.js" integrity="sha512-KaIyHb30iXTXfGyI9cyKFUIRSSuekJt6/vqXtyQKhQP6ozZEGY8nOtRS6fExqE4+RbYHus2yGyYg1BrqxzV6YA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.maskedinput/1.4.1/jquery.maskedinput.min.js" integrity="sha512-d4KkQohk+HswGs6A1d6Gak6Bb9rMWtxjOa0IiY49Q3TeFd5xAzjWXDCBW9RS7m86FQ4RzM2BdHmdJnnKRYknxw==" crossorigin="anonymous" referrerpolicy="no-referrer"></script><script src="https://js.sentry-cdn.com/acc8669eb2c41a158d9ebd151d0aef12.min.js" crossorigin="anonymous"></script><!-- <script src="https://cdn.jsdelivr.net/npm/summernote-cleaner@1.0.0/summernote-cleaner.min.js"></script> --><script src="{{ url('lib_independent') }}/shortcut.js"></script><script src="https://cdn.jsdelivr.net/npm/chart.js"></script>{% block specify_js %}{% endblock %}<script>// Terapkan lokal Indonesia
// flatpickr.l10ns.id.firstDayOfWeek = 1;
// flatpickr.localize(flatpickr.l10ns.id);

window.isPeriodeAktifGlobal = {{ session.isPeriodeAktifGlobal }};
...
}</script><script>{% block inline_script %}{% endblock %}</script><script>// FontAwesome initialization and class management
