		...
		<div id="products">
			...
			<div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-body-emphasis border-top border-bottom border-translucent position-relative top-1">
				<div class="table-responsive scrollbar-overlay mx-n1 px-1">
					<table class="table table-sm fs-9 mb-0 table-striped table-bordered" id="datatables-jenis-audit">
						<thead>
						...
						<tbody class="list" id="jenis-audit-table-body"><!-- Data akan diisi dari script -->
						</tbody>
					</table>
				</div>
			</div>
...
{% block inline_script %}
	{% include "Defaults/Master/JenisAudit/index.js" %}
{% endblock %}
