window.defaultUrl = `${baseUrl}panel/master/wtp/`;
var table;
let rowData;
...
$(document).ready(function () {
	...
	$('#btn-add').click(function (e) {
		...
		$('#nama_wtp').val(null).trigger('change');

		// Clear any hidden fields that might contain previous data
		$('#id_edit').val('');
		manageModal.find("#title_modal").text("Tambah Data WTP")
	...
	$("#btn-delete").click(function (e) {
		...
		$.confirm({
			title: "Konfirmasi",
			theme: "modern",
			content: `Anda yakin ingin menghapus wtp ${rowData.nama_wtp}?`,
			buttons: {
				Tidak: {
					text: "Tidak",
	...
	$('#btn-edit').click(function (e) {
		...
		manageModal.find("#title_modal").text("Ubah Data WTP")
		...
		formManage.find('#nama_wtp').val(rowData.nama_wtp);
...
function renderViewDatatableAction() {
	table = $("#datatables-wtp").DataTable({
		ajax: {
