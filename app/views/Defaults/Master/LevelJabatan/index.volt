...
{% block title %}
    Struktur Organisasi - Level Jabatan
{% endblock %}
...
{% block content %}
	...
	<div class="mb-9">
		<div class="row g-2 mb-4">
			<div class="col-auto">
				<h2 class="mb-0">Level Jabatan</h2>
			</div>
		</div>
		<div id="products">
			<div class="mb-4">
			...
			<div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-body-emphasis border-top border-bottom border-translucent position-relative top-1">
				<div class="table-responsive scrollbar-overlay mx-n1 px-1">
					<table class="table table-sm fs-9 mb-0 table-striped table-bordered" id="datatables-level-jabatan">
						<thead>
						...
						<tbody class="list" id="level-jabatan-table-body"><!-- Data akan diisi dari script -->
						</tbody>
					</table>
				</div>
			</div>
						...
						<div class="col-lg-12">
							<form id="manageForm">
                                ...
                                <div class="mb-2">
									...
									<input class="form-control" type="text" id="deskripsi" name="deskripsi" placeholder="Masukkan Deskripsi ..."/>
								</div>
							...
							<form id="form-filter">
                                ...
                                <div class="mb-1">
									...
									<div class="input-group">
										...
										<input class="form-control" type="text" id="search_deskripsi" name="search_deskripsi" placeholder="Input Deskripsi"/>
									</div>
								</div>
...
{% block inline_script %}
	{% include "Defaults/Master/LevelJabatan/index.js" %}
{% endblock %}
