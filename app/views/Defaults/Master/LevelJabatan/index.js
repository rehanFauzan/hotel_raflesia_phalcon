window.defaultUrl = `${baseUrl}panel/master/master_level_jabatan/`;
var table;
let rowData;
...
$(document).ready(function () {
	...
	$('#btn-add').click(function (e) {
		...
		$('#id_edit').val('');
		manageModal.find("#title_modal").text("Tambah Data Level Jabatan")
	...
	$('#btn-edit').click(function (e) {
		...
		manageModal.find("#title_modal").text("Ubah Data Level Jabatan")
...
function renderViewDatatableAction() {
	table = $("#datatables-level-jabatan").DataTable({
		ajax: {
