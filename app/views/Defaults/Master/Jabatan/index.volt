		...
		<div id="products">
			...
			<div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-body-emphasis border-top border-bottom border-translucent position-relative top-1">
				<div class="table-responsive scrollbar-overlay mx-n1 px-1">
					<table class="table table-sm fs-9 mb-0 table-striped table-bordered" id="datatables-jabatan">
						<thead>
						...
						<tbody class="list" id="jabatan-table-body"><!-- Data akan diisi dari script -->
						</tbody>
					</table>
				</div>
			</div>
					...
					<div class="row g-4">
						<div class="col-lg-12">
							<form id="manageForm">
                                ...
                                <div class="mb-2">
									<label class="text-body-highlight fw-bold mb-2">Level Jabatan</label>
									<select name="level_id" id="level_id" class="form-select"></select>
								</div>

                                <div class="mb-2">
									<label class="text-body-highlight fw-bold mb-2">Bagian</label>
									<select name="bagian_id" id="bagian_id" class="form-select"></select>
								</div>

                                <div class="mb-2">
									<label class="text-body-highlight fw-bold mb-2">Sub Bagian</label>
									<select name="sub_bagian_id" id="sub_bagian_id" class="form-select"></select>
								</div>
							...
							<form id="form-filter">
								...
								<div class="mb-1">
									...
									<div class="input-group">
										...
										<input class="form-control" type="text" id="search_kode" name="search_kode" placeholder="Input Kode"/>
									</div>
								</div>
                                ...
                                <div class="mb-1">
									<label class="text-body-highlight fw-bold mb-2">Level Jabatan</label>
                                    <div class="input-group" id="elFilterLevel">
										<div class="input-group-text">
											<input class="form-check-input toggle-input" type="checkbox"/>
										</div>
										<div class="form-control">
											<select name="search_level_id" id="search_level_id" class="form-select"></select>
										</div>
									</div>
								</div>
                                ...
                                <div class="mb-1">
									<label class="text-body-highlight fw-bold mb-2">Bagian</label>
                                    <div class="input-group" id="elFilterBagian">
										<div class="input-group-text">
											<input class="form-check-input toggle-input" type="checkbox"/>
										</div>
										<div class="form-control">
											<select name="search_bagian_id" id="search_bagian_id" class="form-select"></select>
										</div>
									</div>
								</div>
                                ...
                                <div class="mb-1">
									<label class="text-body-highlight fw-bold mb-2">Sub Bagian</label>
                                    <div class="input-group" id="elFilterSubBagian">
										<div class="input-group-text">
											<input class="form-check-input toggle-input" type="checkbox"/>
										</div>
										<div class="form-control">
											<select name="search_sub_bagian_id" id="search_sub_bagian_id" class="form-select"></select>
										</div>
									</div>
								</div>
...
{% block inline_script %}
	{% include "Defaults/Master/Jabatan/index.js" %}
{% endblock %}
