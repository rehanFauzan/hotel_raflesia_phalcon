window.defaultUrl = `${baseUrl}panel/master/reservoar/`;
var table;
let rowData;
...
$(document).ready(function () {
	...
	$('#btn-add').click(function (e) {
		...
		$('#nama_reservoar').val(null).trigger('change');

		// Clear any hidden fields that might contain previous data
		$('#id_edit').val('');
		manageModal.find("#title_modal").text("Tambah Data Reservoar")
	...
	$("#btn-delete").click(function (e) {
		...
		$.confirm({
			title: "Konfirmasi",
			theme: "modern",
			content: `Anda yakin ingin menghapus reservoar ${rowData.nama_reservoar}?`,
			buttons: {
				Tidak: {
					text: "Tidak",
	...
	$('#btn-edit').click(function (e) {
		...
		manageModal.find("#title_modal").text("Ubah Data Reservoar")
		...
		formManage.find('#nama_reservoar').val(rowData.nama_reservoar);
...
function renderViewDatatableAction() {
	table = $("#datatables-reservoar").DataTable({
		ajax: {
