window.defaultUrl = `${baseUrl}panel/master/master_auditor_eksternal/`;
var table;
let rowData;
...
$(document).ready(function () {
	...
	$('#btn-edit').click(function (e) {
		...
		manageModal.find("#title_modal").text("Ubah Data Auditor Eksternal")
		...
		formManage.find('#telepon').val(rowData.telepon);
		formManage.find('#alamat').val(rowData.alamat);
		formManage.find('#pic').val(rowData.pic);
...
function renderViewDatatableAction() {
	table = $("#datatables-auditor-eksternal").DataTable({
		ajax: {
