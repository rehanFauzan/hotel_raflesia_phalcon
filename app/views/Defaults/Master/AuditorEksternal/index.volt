...
{% block title %}
    Referensi Data - Auditor Eksternal
{% endblock %}
...
{% block content %}
	<nav class="mb-3" aria-label="breadcrumb">
		<ol class="breadcrumb mb-0">
			...
			<li class="breadcrumb-item active">Auditor Eksternal</li>
		</ol>
	</nav>
	<div class="mb-9">
		<div class="row g-2 mb-4">
			<div class="col-auto">
				<h2 class="mb-0">Auditor Eksternal</h2>
			</div>
		</div>
		<div id="products">
			<div class="mb-4">
			...
			<div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-body-emphasis border-top border-bottom border-translucent position-relative top-1">
				<div class="table-responsive scrollbar-overlay mx-n1 px-1">
					<table class="table table-sm fs-9 mb-0 table-striped table-bordered" id="datatables-auditor-eksternal">
						<thead>
						...
						<tbody class="list" id="auditor-eksternal-table-body"><!-- Data akan diisi dari script -->
						</tbody>
					</table>
				</div>
			</div>
					...
					<div class="row g-4">
						<div class="col-lg-12">
							<form id="manageForm">
                                ...
                                <div class="mb-2">
									<label class="text-body-highlight fw-bold mb-2">Telepon</label>
									<input class="form-control" type="text" id="telepon" name="telepon" placeholder="Masukkan Telepon ..."/>
								</div>

                                <div class="mb-2">
									<label class="text-body-highlight fw-bold mb-2">Alamat</label>
									<textarea class="form-control" rows="4" type="text" id="alamat" name="alamat" placeholder="Masukkan Alamat ..."></textarea>
								</div>

                                <div class="mb-2">
									<label class="text-body-highlight fw-bold mb-2">Pic</label>
									<input class="form-control" type="text" id="pic" name="pic" placeholder="Masukkan Pic ..."/>
								</div>
							...
							<form id="form-filter">
                                ...
                                <div class="mb-1">
									...
									<div class="input-group">
										...
										<input class="form-control" type="text" id="search_nama" name="search_nama" placeholder="Input Nama"/>
									</div>
								</div>
                                ...
                                <div class="mb-1">
									...
									<div class="input-group">
										...
										<input class="form-control" type="text" id="search_email" name="search_email" placeholder="Input Email"/>
									</div>
								</div>
                                ...
                                <div class="mb-1">
									...
									<div class="input-group">
										...
										<input class="form-control" type="text" id="search_telepon" name="search_telepon" placeholder="Input Telepon"/>
									</div>
								</div>
                                ...
                                <div class="mb-1">
									...
									<div class="input-group">
										...
										<input class="form-control" type="text" id="search_alamat" name="search_alamat" placeholder="Input Alamat"/>
									</div>
								</div>
                                ...
                                <div class="mb-1">
									...
									<div class="input-group">
										...
										<input class="form-control" type="text" id="search_pic" name="search_pic" placeholder="Input Pic"/>
									</div>
								</div>
...
{% block inline_script %}
	{% include "Defaults/Master/AuditorEksternal/index.js" %}
{% endblock %}
