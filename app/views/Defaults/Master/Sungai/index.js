window.defaultUrl = `${baseUrl}panel/master/sungai/`;
var table;
let rowData;
...
$(document).ready(function () {
	...
	$('#btn-add').click(function (e) {
		...
		$('#nama_sungai').val(null).trigger('change');

		// Clear any hidden fields that might contain previous data
		$('#id_edit').val('');
		manageModal.find("#title_modal").text("Tambah Data Sungai")
	...
	$("#btn-delete").click(function (e) {
		...
		$.confirm({
			title: "Konfirmasi",
			theme: "modern",
			content: `Anda yakin ingin menghapus sungai ${rowData.nama_sungai}?`,
			buttons: {
				Tidak: {
					text: "Tidak",
	...
	$('#btn-edit').click(function (e) {
		...
		manageModal.find("#title_modal").text("Ubah Data Sungai")
		...
		formManage.find('#nama_sungai').val(rowData.nama_sungai);
...
function renderViewDatatableAction() {
	table = $("#datatables-sungai").DataTable({
		ajax: {
