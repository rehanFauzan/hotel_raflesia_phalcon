		...
		<div id="products">
			...
			<div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-body-emphasis border-top border-bottom border-translucent position-relative top-1">
				<div class="table-responsive scrollbar-overlay mx-n1 px-1">
					<table class="table table-sm fs-9 mb-0 table-striped table-bordered" id="datatables-sungai">
						<thead>
						...
						<tbody class="list" id="sungai-table-body"><!-- Data akan diisi dari script -->
						</tbody>
					</table>
				</div>
			</div>
					...
					<div class="row g-4">
						<div class="col-lg-12">
							<form id="manageForm">
                                ...
                                <div class="mb-2">
									<label class="text-body-highlight fw-bold mb-2">Nama Sungai</label>
									<input class="form-control" type="text" id="nama_sungai" name="nama_sungai" placeholder="Masukkan Nama Sungai ..."/>
								</div>
							...
							<form id="form-filter">
                                ...
                                <div class="mb-1">
									...
									<div class="input-group">
										...
										<input class="form-control" type="text" id="search_nama_sungai" name="search_nama_sungai" placeholder="Input Nama Sungai"/>
									</div>
								</div>
...
{% block inline_script %}
	{% include "Defaults/Master/Sungai/index.js" %}
{% endblock %}
