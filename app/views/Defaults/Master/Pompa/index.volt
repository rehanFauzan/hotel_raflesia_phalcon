...
{% block content %}
	<nav class="mb-3" aria-label="breadcrumb">
		<ol class="breadcrumb mb-0">
			...
			<li class="breadcrumb-item active">Pompa</li>
		</ol>
	</nav>
	<div class="mb-9">
		<div class="row g-2 mb-4">
			<div class="col-auto">
				<h2 class="mb-0">Pompa</h2>
			</div>
		</div>
		<div id="products">
			<div class="mb-4">
							...
							<form id="form-filter">
                                ...
                                <div class="mb-1">
									...
									<div class="input-group">
										...
										<input class="form-control" type="text" id="search_nama_pompa" name="search_nama_pompa" placeholder="Input Pompa"/>
									</div>
								</div>
...
{% block inline_script %}
	{% include "Defaults/Master/Pompa/index.js" %}
{% endblock %}
