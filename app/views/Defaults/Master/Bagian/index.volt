		...
		<div id="products">
			...
			<div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-body-emphasis border-top border-bottom border-translucent position-relative top-1">
				<div class="table-responsive scrollbar-overlay mx-n1 px-1">
					<table class="table table-sm fs-9 mb-0 table-striped table-bordered" id="datatables-bagian">
						<thead>
						...
						<tbody class="list" id="bagian-table-body"><!-- Data akan diisi dari script -->
						</tbody>
					</table>
				</div>
			</div>
					...
					<div class="row g-4">
						<div class="col-lg-12">
							<form id="manageForm">
                                ...
                                <div class="mb-2">
									<label class="text-body-highlight fw-bold mb-2">Direktorat</label>
									<select name="direktorat_id" id="direktorat_id" class="form-select"></select>
								</div>
					...
					<div class="row g-4">
						<div class="col-lg-12">
							<form id="form-filter">
                                ...
                                <div class="mb-1">
									<label class="text-body-highlight fw-bold mb-2">Direktorat</label>
                                    <div class="input-group" id="elFilterDirektorat">
										<div class="input-group-text">
											<input class="form-check-input toggle-input" type="checkbox"/>
										</div>
										<div class="form-control">
											<select name="search_direktorat_id" id="search_direktorat_id" class="form-select"></select>
										</div>
									</div>
								</div>
...
{% block inline_script %}
	{% include "Defaults/Master/Bagian/index.js" %}
{% endblock %}
