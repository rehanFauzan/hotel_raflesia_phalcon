window.defaultUrl = `${baseUrl}panel/master/pompa_tekanan_kolektor/`;
var table;
let rowData;
...
$(document).ready(function () {
	...
	$('#btn-add').click(function (e) {
		...
		$('#nama_pompa').val(null).trigger('change');

		// Clear any hidden fields that might contain previous data
		$('#id_edit').val('');
		manageModal.find("#title_modal").text("Tambah Data Pompa Tekanan Kolektor")
	...
	$("#btn-delete").click(function (e) {
		...
		$.confirm({
			title: "Konfirmasi",
			theme: "modern",
			content: `Anda yakin ingin menghapus pompa ${rowData.nama_pompa}?`,
			buttons: {
				Tidak: {
					text: "Tidak",
	...
	$('#btn-edit').click(function (e) {
		...
		manageModal.find("#title_modal").text("Ubah Data Pompa Tekanan Kolektor")
		...
		formManage.find('#nama_pompa').val(rowData.nama_pompa);
...
function renderViewDatatableAction() {
	table = $("#datatables-pompa").DataTable({
		ajax: {
