...
{% block title %}
    Referensi Master - Pompa Tekanan Kolektor
{% endblock %}
...
{% block content %}
	<nav class="mb-3" aria-label="breadcrumb">
		<ol class="breadcrumb mb-0">
			...
			<li class="breadcrumb-item active">Pompa Tekanan Kolektor</li>
		</ol>
	</nav>
	<div class="mb-9">
		<div class="row g-2 mb-4">
			<div class="col-auto">
				<h2 class="mb-0">Pompa Tekanan Kolektor</h2>
			</div>
		</div>
		<div id="products">
			<div class="mb-4">
			...
			<div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-body-emphasis border-top border-bottom border-translucent position-relative top-1">
				<div class="table-responsive scrollbar-overlay mx-n1 px-1">
					<table class="table table-sm fs-9 mb-0 table-striped table-bordered" id="datatables-pompa">
						<thead>
						...
						<tbody class="list" id="pompa-table-body"><!-- Data akan diisi dari script -->
						</tbody>
					</table>
				</div>
			</div>
					...
					<div class="row g-4">
						<div class="col-lg-12">
							<form id="manageForm">
                                ...
                                <div class="mb-2">
									<label class="text-body-highlight fw-bold mb-2">Nama Pompa</label>
									<input class="form-control" type="text" id="nama_pompa" name="nama_pompa" placeholder="Masukkan Nama Pompa ..."/>
								</div>
							...
							<form id="form-filter">
                                ...
                                <div class="mb-1">
									...
									<div class="input-group">
										...
										<input class="form-control" type="text" id="search_nama_pompa" name="search_nama_pompa" placeholder="Input Pompa Tekanan Kolektor"/>
									</div>
								</div>
...
{% block inline_script %}
	{% include "Defaults/Master/PompaTekananKolektor/index.js" %}
{% endblock %}
