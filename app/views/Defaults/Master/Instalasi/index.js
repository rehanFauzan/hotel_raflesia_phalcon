window.defaultUrl = `${baseUrl}panel/master/instalasi/`;
var table;
let rowData;
...
$(document).ready(function () {
	...
	$('#btn-add').click(function (e) {
		...
		$('#id_edit').val('');
		manageModal.find("#title_modal").text("Tambah Data Instalasi")
	...
	$("#btn-delete").click(function (e) {
		...
		$.confirm({
			title: "Konfirmasi",
			theme: "modern",
			content: `Anda yakin ingin menghapus instalasi (${rowData.kode_installasi}) ${rowData.nama_installasi}?`,
			buttons: {
				Tidak: {
					text: "Tidak",
	...
	$('#btn-edit').click(function (e) {
		...
		manageModal.find("#title_modal").text("Ubah Data Instalasi")
		formManage.find('#input-action').val('update');
		formManage.find('#id_edit').val(rowData.id);
		
        formManage.find('#kode_instalasi').val(rowData.kode_installasi);
		formManage.find('#nama_instalasi').val(rowData.nama_installasi);
...
function renderViewDatatableAction() {
	table = $("#datatables-instalasi").DataTable({
		ajax: {
