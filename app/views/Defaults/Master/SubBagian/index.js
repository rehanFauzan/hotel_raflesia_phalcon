window.defaultUrl = `${baseUrl}panel/master/master_sub_bagian/`;
var table;
let rowData;
...
$(document).ready(function () {
	...
	$('#btn-add').click(function (e) {
		...
		$('#id_edit').val('');
		manageModal.find("#title_modal").text("Tambah Data Sub Bagian")
	...
	$('#btn-edit').click(function (e) {
        ...
        if (!_.isEmpty(rowData.bagian_id)) {
            formManage.find("#bagian_id").select2("trigger", "select", {
                data: {
                    id: rowData.bagian_id,
                    kode: rowData.bagian_kode,
                    nama: rowData.bagian_nama,
                    text: `(${rowData.bagian_kode}) ${rowData.bagian_nama}`,
                    selected: true
                }
            });
        }
...
function renderViewDatatableAction() {
	table = $("#datatables-sub-bagian").DataTable({
		ajax: {
