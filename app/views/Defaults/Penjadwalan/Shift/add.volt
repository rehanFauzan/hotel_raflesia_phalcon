...
{% block title %}
    Penjadwalan - Tambah Penjadwalan Shift
{% endblock %}
...
{% block content %}
	<nav class="mb-3" aria-label="breadcrumb">
		<ol class="breadcrumb mb-0">
			...
			<li class="breadcrumb-item active">Tambah Penjadwalan Shift</li>
		</ol>
	</nav>
	<div class="mb-9">
		<div class="row g-2 mb-4">
			<div class="col-auto">
				<h2 class="mb-0">Tambah Penjadwalan Shift</h2>
			</div>
		</div>
		<div id="products">
			<div class="mb-4">
			...
			<div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-body-emphasis border-top border-bottom border-translucent position-relative top-1">
				<div class="table-responsive scrollbar-overlay mx-n1 px-1">
					<table class="table table-sm fs-9 mb-0 table-striped table-bordered" id="datatables-instalasi">
						<thead>
						...
						<tbody class="list" id="instalasi-table-body"><!-- Data akan diisi dari script -->
						</tbody>
					</table>
				</div>
			</div>
					...
					<div class="row g-4">
						<div class="col-lg-12">
							<form id="manageForm">
                                ...
                                <div class="mb-2">
									<label class="text-body-highlight fw-bold mb-2">Kode Instalasi</label>
									<input class="form-control" type="text" id="kode_instalasi" name="kode_instalasi" placeholder="Masukkan Kode Instalasi ..."/>
								</div>
                                
                                <div class="mb-2">
									<label class="text-body-highlight fw-bold mb-2">Nama Instalasi</label>
									<input class="form-control" type="text" id="nama_instalasi" name="nama_instalasi" placeholder="Masukkan Nama Instalasi ..."/>
								</div>
							...
							<form id="form-filter">
                                ...
                                <div class="mb-1">
									...
									<div class="input-group">
										...
										<input class="form-control" type="text" id="search_kode" name="search_kode" placeholder="Input Kode Instalasi"/>
									</div>
								</div>
                                ...
                                <div class="mb-1">
									...
									<div class="input-group">
										...
										<input class="form-control" type="text" id="search_nama" name="search_nama" placeholder="Input Nama Instalasi"/>
									</div>
								</div>
...
{% block inline_script %}
	{% include "Defaults/Penjadwalan/Shift/add.js" %}
{% endblock %}
