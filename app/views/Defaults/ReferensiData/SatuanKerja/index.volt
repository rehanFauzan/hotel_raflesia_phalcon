		...
		<div id="roles">
			...
			<div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-body-emphasis border-top border-bottom border-translucent position-relative top-1">
				<div class="table-responsive scrollbar-overlay mx-n1 px-1">
					<table class="table table-sm fs-9 mb-0 table-striped table-bordered" id="datatables-satker">
						<thead>
						...
						<tbody class="list" id="satker-table-body"><!-- Data akan diisi dari script -->
						</tbody>
					</table>
				</div>
			</div>
						...
						<div class="col-lg-12">
							<form id="manageForm">
                                ...
                                <div class="mb-2">
									...
									<input class="form-control" type="text" id="kode_satker" name="kode_satker" placeholder="Masukkan Kode Satuan Kerja ..."/>
								</div>

								<div class="mb-2">
									<label class="text-body-highlight fw-bold mb-2">Nama</label>
									<input class="form-control" type="text" id="nama_satker" name="nama_satker" placeholder="Masukkan Nama Satuan Kerja ..."/>
								</div>
...
{% block inline_script %}
	{% include "Defaults/ReferensiData/SatuanKerja/index.js" %}
{% endblock %}
