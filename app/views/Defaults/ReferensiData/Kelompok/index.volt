		...
		<div id="kelompok">
			...
			<div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-body-emphasis border-top border-bottom border-translucent position-relative top-1">
				<div class="table-responsive scrollbar-overlay mx-n1 px-1">
					<table class="table table-sm fs-9 mb-0 table-striped table-bordered" id="datatables-kelompok">
						<thead>
						...
						<tbody class="list" id="kelompok-table-body"><!-- Data akan diisi dari script -->
						</tbody>
					</table>
				</div>
			</div>
					...
					<div class="row g-4">
						<div class="col-lg-12">
							<form id="manageForm">
                                ...
                                <div class="mb-3" id="elSelect2Golongan">
                                    <label class="text-body-highlight fw-bold mb-2">Golongan</label>
                                    <select name="acc_parent_gol" id="acc_parent_gol" class="form-select"></select>
                                </div>
							...
							<form id="form-filter">
								...
								<div class="mb-1">
									...
									<div class="input-group">
										...
										<input class="form-control" type="text" id="search_acc_code" name="search_acc_code" placeholder="Cari berdasarkan kode.."/>
									</div>
								</div>
								...
								<div class="mb-1">
									...
									<div class="input-group">
										...
										<input class="form-control" type="text" id="search_acc_name" name="search_acc_name" placeholder="Cari berdasarkan nama.."/>
									</div>
								</div>

								<div class="mb-1">
									<label class="text-body-highlight fw-bold mb-2">Golongan</label>
									<div class="input-group" id="elFilterParentGol">
										<div class="input-group-text">
											<input class="form-check-input toggle-input" type="checkbox"/>
										</div>
										<div class="form-control">
											<select name="search_acc_parent_gol" id="search_acc_parent_gol" class="form-control"></select>
										</div>
									</div>
								</div>								
...
{% block inline_script %}
	{% include "Defaults/ReferensiData/Kelompok/index.js" %}
{% endblock %}
