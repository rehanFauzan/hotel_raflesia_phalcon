window.defaultUrl = `${baseUrl}panel/refdata/ajuan/`;
var title_modal = `Tambah Ajuan`;
var table;
let rowData;
...
$(document).ready(function () {
    ...
    $('#btn-add').click(function (e) {
        ...
        $('#id_edit').val('');
        manageModal.find("#title_modal").text("Tambah Data Ajuan")

        // formManage.find('#kode').attr('readonly', false);
    ...
    $('#btn-edit').click(function (e) {
        ...
        formManage.find('#id_edit').val(rowData.kode);
        formManage.find('#kode').val(rowData.kode);
        // formManage.find('#kode').attr('readonly', true);

        formManage.find('#nama').val(rowData.nama);
        formManage.find('#alamat').val(rowData.alamat);
        formManage.find('#npwp').val(rowData.npwp);
        formManage.find('#penanggung_jawab').val(rowData.penanggung_jawab);
        formManage.find('#is_rekanan').val(rowData.is_rekanan);
...
function renderViewDatatableAction() {
    table = $("#datatables-ajuan").DataTable({
        ajax: {
