...
{% block content %}
	<nav class="mb-3" aria-label="breadcrumb">
		<ol class="breadcrumb mb-0">
			...
			<li class="breadcrumb-item active">Mapping Akun Jurnal</li>
		</ol>
	</nav>
	<div class="mb-9">
		<div class="row g-2 mb-4">
			<div class="col-auto">
				<h2 class="mb-0">Mapping Akun Jurnal</h2>
			</div>
		</div>
		<div id="kelompok">
			<div class="mb-4">
			...
			<div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-body-emphasis border-top border-bottom border-translucent position-relative top-1">
				<div class="table-responsive scrollbar-overlay mx-n1 px-1">
					<table class="table table-sm fs-9 mb-0 table-striped table-bordered" id="datatables-mapping">
						<thead>
							<tr
						...
						<tbody
							class="list" id="mapping-table-body"><!-- Data akan diisi dari script -->
						</tbody>
					</table>
				</div>
			</div>
					...
					<div class="row g-4">
						<div class="col-lg-12">
							<form id="manageForm">
								...
								<div class="mb-3" id="elSelect2Perkiraan">
									<label class="text-body-highlight fw-bold mb-2">Pekiraan</label>
									<select name="acc_code" id="acc_code" class="form-select"></select>
								</div>

								<div class="mb-3" id="elSelect2ReffJurnal">
									<label class="text-body-highlight fw-bold mb-2">Jurnal</label>
									<select name="jt_id" id="jt_id" class="form-select"></select>
								</div>

								<div class="mb-2">
									<label class="text-body-highlight fw-bold mb-2">Nilai</label>
									<select name="is_debet" id="is_debet" class="form-select">
					...
					<div class="row g-4">
						<div class="col-lg-12">
							<form id="form-filter">
                                ...
                                <div class="mb-1">
									<label class="text-body-highlight fw-bold mb-2">Perkiraan</label>
									<div class="input-group" id="elFilterPerkiraan">
										<div class="input-group-text">
											<input class="form-check-input toggle-input" type="checkbox"/>
										</div>
										<div class="form-control">
											<select name="search_acc_code" id="search_acc_code" class="form-control"></select>
										</div>
									</div>
								</div>
                                ...
                                <div class="mb-1">
									<label class="text-body-highlight fw-bold mb-2">Jurnal</label>
									<div class="input-group" id="elFilterJurnal">
										<div class="input-group-text">
											<input class="form-check-input toggle-input" type="checkbox"/>
										</div>
										<div class="form-control">
											<select name="search_jt_id" id="search_jt_id" class="form-control"></select>
										</div>
									</div>
								</div>
                                ...
                                <div class="mb-1">
									<label class="text-body-highlight fw-bold mb-2">Nilai</label>
									<div class="input-group" id="elFilterNilai">
										<div class="input-group-text">
											<input class="form-check-input toggle-input" type="checkbox"/>
										</div>
										<div class="form-control">
											<select name="search_is_debet" id="search_is_debet" class="form-control">
                                                <option value="" selected disabled>Pilih Nilai</option>
                                                <option value="1">DEBET</option>
                                                <option value="2">KREDIT</option>
                                            </select>
...
{% block inline_script %}
	{% include "Defaults/ReferensiData/Mapping/index.js" %}
{% endblock %}
