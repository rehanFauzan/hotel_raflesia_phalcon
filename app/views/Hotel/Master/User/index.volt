...
{% block inline_style %}
	<style>
		...
		#datatables-user tbody tr {
			height: 50px;
		}
		#datatables-user tbody td {
			padding: 12px 10px;
		}
	</style>
{% endblock %}
					...
					<table class="table table-sm fs-9 mb-0 table-striped table-bordered" id="datatables-user">
						<thead>
							<tr class="p-2 text-center">
								...
								<th class="sort px-2" scope="col">Username</th>
		...
		<div class="modal-dialog modal-xl modal-dialog-centered">
			<div class="modal-content bg-body-highlight p-6">
				<div class="modal-header justify-content-between border-0 p-0 mb-2">
					<h3 class="mb-0">Filter Data User</h3>
							...
							<form id="form-filter">
								<div class="mb-3">
									...
									<div class="input-group">
										...
										<input class="form-control" type="text" id="search_username" name="search_username" placeholder="Cari berdasarkan username..."/>
									</div>
								</div>
...
{% block inline_script %}
	{% include "Hotel/Master/User/index.js" %}
{% endblock %}