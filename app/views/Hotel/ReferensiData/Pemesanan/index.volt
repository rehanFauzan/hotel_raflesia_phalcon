...
{% block inline_style %}
	<style>
		...
		#datatables-pemesanan tbody tr {
			height: 50px;
		}
		#datatables-pemesanan tbody td {
			padding: 12px 10px;
		}
	</style>
{% endblock %}
		...
		<div id="products">
			...
			<div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-body-emphasis border-top border-bottom border-translucent position-relative top-1">
				<div class="table-responsive scrollbar-overlay mx-n1 px-1">
					<table class="table table-sm fs-9 mb-0 table-striped table-bordered" id="datatables-pemesanan">
						<thead>
						...
						<tbody class="list" id="pemesanan-table-body"></tbody>
					</table>
				</div>
			</div>
		</div>
		...
		<div class="modal-dialog modal-xl modal-dialog-centered">
			<div class="modal-content bg-body-highlight p-6">
				<div class="modal-header justify-content-between border-0 p-0 mb-2">
					<h3 class="mb-0">Filter Data Pemesanan</h3>
				...
				<div class="modal-body px-0">
					<div class="row g-4">
						<div class="col-lg-12">
							<form id="form-filter">
								<div class="mb-3">
									<label class="text-body-highlight fw-bold mb-2">Tamu</label>
									<div class="input-group">
										<div class="input-group-text">
											<input class="form-check-input toggle-input" type="checkbox"/>
										</div>
										<div class="form-control">
											<select name="search_tamu" id="search_tamu" class="form-control">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="mb-3">
											<label class="text-body-highlight fw-bold mb-2">Tanggal Check In</label>
											<div class="input-group">
												<div class="input-group-text">
													<input class="form-check-input toggle-input" type="checkbox"/>
												</div>
												<input class="form-control" type="date" id="search_checkin" name="search_checkin"/>
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="mb-3">
											<label class="text-body-highlight fw-bold mb-2">Tanggal Check Out</label>
											<div class="input-group">
												<div class="input-group-text">
													<input class="form-check-input toggle-input" type="checkbox"/>
												</div>
												<input class="form-control" type="date" id="search_checkout" name="search_checkout"/>
											</div>
										</div>
									</div>
								</div>
							...
							<form id="manageForm">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="mb-2">
											<label class="text-body-highlight fw-bold mb-2">Tamu</label>
											<select class="form-control" id="tamu_id" name="tamu_id">
												<option value="">Pilih Tamu</option>
											</select>
										</div>
									</div>
									<div class="col-md-6">
										<div class="mb-2">
											<label class="text-body-highlight fw-bold mb-2">Kamar</label>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="mb-2">
											<label class="text-body-highlight fw-bold mb-2">Tanggal Check In</label>
											<input class="form-control" type="date" id="tanggal_checkin" name="tanggal_checkin"/>
										</div>
									</div>
									<div class="col-md-6">
										<div class="mb-2">
											<label class="text-body-highlight fw-bold mb-2">Tanggal Check Out</label>
											<input class="form-control" type="date" id="tanggal_checkout" name="tanggal_checkout"/>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="mb-2">
											<label class="text-body-highlight fw-bold mb-2">Jumlah Tamu</label>
											<input class="form-control" type="number" id="jumlah_tamu" name="jumlah_tamu" value="1"/>
										</div>
									</div>
									<div class="col-md-6">
										<div class="mb-2">
											<label class="text-body-highlight fw-bold mb-2">Total Harga</label>
											<input class="form-control" type="number" id="total_harga" name="total_harga" readonly/>
											<small class="text-muted">Total harga akan dihitung otomatis berdasarkan kamar dan tanggal</small>
								...
								<div class="mb-2">
									<label class="text-body-highlight fw-bold mb-2">Catatan Khusus</label>
...
{% block inline_script %}
	{% include "Hotel/ReferensiData/Pemesanan/index.js" %}
{% endblock %}
